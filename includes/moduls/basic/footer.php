  <footer>
      <div class="left-side">
          <p>© 2020 KAFESOFT.UZ <br>
              Пользовательское соглашение <br>
              Политика конфиденциальности</p>
      </div>
      <div>
          <!-- <ul class="right-side">
              <li><a href="#"><img class="twit" src="../../../resources/assets/icons/twit.svg" alt=""></a></li>
              <li><a href="#"><img class="inst" src="../../../resources/assets/icons/instagram.svg" alt="instagram"></a></li>
              <li><a href="https://www.facebook.com/sherzod.shukrjanov.5"><img class="face" src="../../../resources/assets/icons/facebook.svg" alt="facebook"></a></li>
